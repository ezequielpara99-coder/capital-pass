...
export default function UpgradeScreen({ plan, blocked = false }: { plan: Plan; blocked?: boolean }) {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative mx-auto max-w-xl px-5 py-20 text-center">
        ...
        {blocked ? (
          <>
            <h1 className="mt-4 text-3xl font-black">Acceso a Stock restringido</h1>
            <p className="mt-3 text-sm text-white/50">
              El módulo de Stock (barras, bartenders y mesas) está restringido para tu cuenta por ahora. El resto de
              Capital Pass sigue funcionando normal. Si necesitás que lo habilitemos, escribinos.
            </p>
          </>
        ) : (
          <>
